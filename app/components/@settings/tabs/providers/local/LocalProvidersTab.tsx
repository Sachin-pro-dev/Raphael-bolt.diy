          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3">
            ...
            <div className="flex items-center gap-2">
              <Button
                ...
                className="bg-bolt-elements-background-depth-2 hover:bg-bolt-elements-background-depth-3 border-bolt-elements-borderColor hover:border-cyan-500/30 transition-all duration-200 gap-2"
              >
                    ...
                    {isLoadingModels ? (
                      ...
                      <div className="text-center py-8">
                        ...
                        <Button
                          variant="outline"
                          size="sm"
                          className="bg-gradient-to-r from-cyan-500/8 to-cyan-600/8 hover:from-cyan-500/15 hover:to-cyan-600/15 border-cyan-500/25 hover:border-cyan-500/40 transition-all duration-300 gap-2 group shadow-sm hover:shadow-md font-medium"
                          _asChild
                        >
                          <a
                            href="https://ollama.com/library"
