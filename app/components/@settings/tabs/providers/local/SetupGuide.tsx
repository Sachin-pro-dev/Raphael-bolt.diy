...
function SetupGuide({ onBack }: { onBack: () => void }) {
  return (
    <div className="space-y-6">
      ...
      <Card className="bg-gradient-to-r from-blue-500/10 to-cyan-500/10 border border-blue-500/20 shadow-sm">
      ...
      <Card className="bg-bolt-elements-background-depth-2 shadow-sm">
        <CardHeader className="pb-6">
          <div className="flex items-center gap-4">
            ...
            <span className="px-3 py-1 bg-cyan-500/10 text-cyan-500 text-xs font-medium rounded-full">Recommended</span>
          </div>
        </CardHeader>
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <div className="p-3 rounded-lg bg-bolt-elements-background-depth-3">
                  ...
                  <Button
                    variant="outline"
                    size="sm"
                    className="w-full bg-gradient-to-r from-cyan-500/10 to-cyan-600/10 hover:from-cyan-500/20 hover:to-cyan-600/20 border-cyan-500/30 hover:border-cyan-500/50 transition-all duration-300 gap-2 group shadow-sm hover:shadow-lg hover:shadow-cyan-500/20 font-medium"
                    _asChild
                  >
                    <a
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div className="p-4 rounded-lg bg-cyan-500/5 border border-cyan-500/20">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <span className="font-medium text-cyan-500">Performance Optimized</span>
                </div>
      ...
      <Card className="bg-gradient-to-r from-cyan-500/10 to-pink-500/10 border border-cyan-500/20 shadow-sm">
