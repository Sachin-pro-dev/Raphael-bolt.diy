...
function ModelCard({ model, onUpdate, onDelete }: ModelCardProps) {
  return (
    <Card className="bg-bolt-elements-background-depth-3 hover:bg-bolt-elements-background-depth-4 transition-all duration-200 shadow-sm hover:shadow-md border border-bolt-elements-borderColor hover:border-cyan-500/20">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className={classNames(
                ...
                'bg-cyan-500/10 text-cyan-500 hover:bg-cyan-500/20 hover:shadow-sm',
