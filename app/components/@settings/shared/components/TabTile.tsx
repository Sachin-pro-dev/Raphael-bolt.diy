            ...
            <div className="relative h-full rounded-xl border border-[#E5E5E5] dark:border-[#333333] p-0.5">
              ...
              <div
                ...
                className={classNames(
                  ...
                  isActive ? 'bg-cyan-500/5 dark:bg-cyan-500/10' : '',
                    ...
                    return (
                      <IconComponent
                        className={classNames(
                          ...
                          'group-hover:text-cyan-500 dark:group-hover:text-cyan-400/80',
                          'transition-colors duration-100 ease-out',
                          isActive ? 'text-cyan-500 dark:text-cyan-400/90' : '',
                        )}
                      />
                    );
                  })()}
                ...
                <div className="flex flex-col items-center mt-4 w-full">
                  <h3
                    className={classNames(
                      ...
                      'group-hover:text-cyan-600 dark:group-hover:text-cyan-300/90',
                      'transition-colors duration-100 ease-out',
                      isActive ? 'text-cyan-500 dark:text-cyan-400/90' : '',
                    )}
                  >
                  ...
                  {description && (
                    <p
                      className={classNames(
                        ...
                        'max-w-[85%]',
                        'text-center',
                        'group-hover:text-cyan-500 dark:group-hover:text-cyan-400/70',
                        'transition-colors duration-100 ease-out',
                        isActive ? 'text-cyan-400 dark:text-cyan-400/80' : '',
                      )}
                    >
                      {description}
                    </p>
