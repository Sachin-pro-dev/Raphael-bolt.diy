...
function CurrentDateTime() {
  ...
  return (
    <div className="flex items-center gap-2 px-4 py-2 text-sm text-gray-600 dark:text-gray-400 border-b border-gray-100 dark:border-white/15">
    ...
    <>
      <motion.div
        ...
        className={classNames(
          ...
          'bg-white/90 dark:bg-black/80 backdrop-blur-xl border-r border-bolt-elements-borderColor',
          'shadow-[4px_0_24px_rgba(0,229,255,0.08)] text-sm',
        ...
        <div className="flex-1 flex flex-col h-full w-full overflow-hidden">
          <div className="p-4 space-y-3">
            <div className="flex gap-2">
              <a
                href="/"
                className="flex-1 flex gap-2 items-center bg-cyan-50 dark:bg-cyan-500/10 text-cyan-700 dark:text-cyan-300 hover:bg-cyan-100 dark:hover:bg-cyan-500/20 rounded-lg px-4 py-2 transition-colors"
              >
              ...
              <button
                ...
                className={classNames(
                  ...
                  selectionMode
                    ? 'bg-cyan-600 dark:bg-cyan-500 text-white border border-cyan-700 dark:border-cyan-600'
            ...
            <div className="relative w-full">
              ...
              <input
                className="w-full bg-gray-50 dark:bg-transparent relative pl-9 pr-3 py-2 rounded-lg focus:outline-none focus:ring-1 focus:ring-cyan-500/50 text-sm text-gray-900 dark:text-gray-100 placeholder-gray-500 dark:placeholder-gray-500 border border-gray-200 dark:border-[rgba(0,229,255,0.15)]"
                type="search"
            ...
            <DialogRoot open={dialogContent !== null}>
              {binDates(filteredList).map(({ category, items }) => (
                <div key={category} className="mt-2 first:mt-0 space-y-1">
                  <div className="text-xs font-medium text-gray-500 dark:text-gray-400 sticky top-0 z-1 bg-white dark:bg-black px-4 py-1">
                    {category}
                  </div>
              ...
              <Dialog onBackdrop={closeDialog} onClose={closeDialog}>
                {dialogContent?.type === 'delete' && (
                  <>
                    ...
                    <div className="flex justify-end gap-3 px-6 py-4 bg-gray-50 dark:bg-black/80 border-t border-gray-100 dark:border-white/15">
                  ...
                  <>
                    <div className="p-6 bg-white dark:bg-black">
                      ...
                      <DialogDescription className="mt-2 text-gray-600 dark:text-gray-400">
                        ...
                        <div className="mt-2 max-h-32 overflow-auto border border-gray-100 dark:border-white/15 rounded-md bg-gray-50 dark:bg-black/80 p-2">
          ...
          <div className="flex items-center justify-between border-t border-gray-200 dark:border-white/15 px-4 py-3">
            <div className="flex items-center gap-3">
