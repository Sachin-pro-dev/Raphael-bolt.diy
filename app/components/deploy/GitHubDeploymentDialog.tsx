                ...
                <div className="p-6 space-y-4">
                  ...
                  <div className="bg-bolt-elements-background-depth-2 dark:bg-bolt-elements-background-depth-3 rounded-lg p-4 text-left border border-bolt-elements-borderColor dark:border-bolt-elements-borderColor-dark">
                    <p className="text-sm font-medium text-bolt-elements-textPrimary dark:text-bolt-elements-textPrimary-dark mb-2 flex items-center gap-2">
                      <span className="i-ph:github-logo w-4 h-4 text-cyan-500" />
                      Repository URL
                    </p>
                  ...
                  <div className="bg-bolt-elements-background-depth-2 dark:bg-bolt-elements-background-depth-3 rounded-lg p-4 border border-bolt-elements-borderColor dark:border-bolt-elements-borderColor-dark">
                    <p className="text-sm font-medium text-bolt-elements-textPrimary dark:text-bolt-elements-textPrimary-dark mb-2 flex items-center gap-2">
                      <span className="i-ph:files w-4 h-4 text-cyan-500" />
                  ...
                  <div className="flex justify-end gap-2 pt-2">
                    <motion.a
                      ...
                      className="px-4 py-2 rounded-lg bg-cyan-500 text-white hover:bg-cyan-600 text-sm inline-flex items-center gap-2"
              ...
              >
                ...
                <div className="relative text-center space-y-4">
                  ...
                  <motion.div
                    ...
                    className="mx-auto w-16 h-16 rounded-xl bg-bolt-elements-background-depth-3 flex items-center justify-center text-cyan-500"
                  >
                  ...
                  <div className="pt-2 flex justify-center gap-3">
                    ...
                    <motion.button
                      ...
                      className="px-4 py-2 rounded-lg bg-cyan-500 text-white text-sm hover:bg-cyan-600 inline-flex items-center gap-2"
                      whileHover={{ scale: 1.02 }}
                      whileTap={{ scale: 0.98 }}
                    >
                      <div className="i-ph:github-logo w-4 h-4" />
              ...
              <div className="p-6">
                <div className="flex items-center gap-4 mb-6">
                  <motion.div
                    ...
                    animate={{ scale: 1 }}
                    transition={{ delay: 0.1 }}
                    className="w-10 h-10 rounded-xl bg-bolt-elements-background-depth-3 flex items-center justify-center text-cyan-500"
                  >
                ...
                <div className="flex items-center gap-3 mb-6 p-4 bg-bolt-elements-background-depth-2 dark:bg-bolt-elements-background-depth-3 rounded-lg border border-bolt-elements-borderColor dark:border-bolt-elements-borderColor-dark">
                  <div className="relative">
                    ...
                    <div className="absolute -bottom-1 -right-1 w-5 h-5 rounded-full bg-cyan-500 flex items-center justify-center text-white">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full pl-10 px-4 py-2 rounded-lg bg-bolt-elements-background-depth-2 dark:bg-bolt-elements-background-depth-3 border border-bolt-elements-borderColor dark:border-bolt-elements-borderColor-dark text-bolt-elements-textPrimary dark:text-bolt-elements-textPrimary-dark placeholder-bolt-elements-textTertiary dark:placeholder-bolt-elements-textTertiary-dark focus:outline-none focus:ring-2 focus:ring-cyan-500"
                        required
                        maxLength={100}
                    ...
                    {repoName && sanitizeRepoName(repoName) !== repoName && (
                      <p className="text-xs text-bolt-elements-textSecondary dark:text-bolt-elements-textSecondary-dark mt-1">
                        Will be created as:{' '}
                        <span className="font-mono text-cyan-600 dark:text-cyan-400">{sanitizeRepoName(repoName)}</span>
                      </p>
                    )}
                  </div>
                        ...
                        {filteredRepos.length === 0 && repoSearchQuery.trim() !== '' ? (
                          ...
                          filteredRepos.map((repo) => (
                            ...
                            >
                              <div className="flex items-center justify-between">
                                <div className="flex items-center gap-2">
                                  <div className="i-ph:git-branch w-4 h-4 text-cyan-500" />
                                  <span className="text-sm font-medium text-bolt-elements-textPrimary dark:text-bolt-elements-textPrimary-dark group-hover:text-cyan-500">
                                    {repo.name}
                                  </span>
                                </div>
                                {repo.private && (
                  ...
                  <div className="p-3 bg-bolt-elements-background-depth-2 dark:bg-bolt-elements-background-depth-3 rounded-lg border border-bolt-elements-borderColor dark:border-bolt-elements-borderColor-dark">
                    <div className="flex items-center gap-2">
                      <input
                        ...
                        className="rounded border-bolt-elements-borderColor dark:border-bolt-elements-borderColor-dark text-cyan-500 focus:ring-cyan-500 dark:bg-bolt-elements-background-depth-3"
                      />
                      <label
                        htmlFor="private"
                  ...
                  <div className="pt-4 flex gap-2">
                    ...
                    <motion.button
                      ...
                      className={classNames(
                        'flex-1 px-4 py-2 bg-cyan-500 text-white rounded-lg hover:bg-cyan-600 text-sm inline-flex items-center justify-center gap-2',
