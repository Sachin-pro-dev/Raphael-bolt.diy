  ...
  return (
    <div className="flex gap-2 flex-col sm:flex-row">
      ...
      <div className="relative flex w-full" onKeyDown={handleProviderKeyDown} ref={providerDropdownRef}>
        <div
          className={classNames(
            ...
            isProviderDropdownOpen
              ? 'ring-2 ring-cyan-500/40 border-cyan-500/30 shadow-[0_0_12px_rgba(0,229,255,0.1)]'
              : 'hover:border-cyan-500/20 hover:shadow-[0_0_8px_rgba(0,229,255,0.06)]',
          )}
        ...
        >
          <div className="flex items-center justify-between">
            ...
            <div
              className={classNames(
                'i-ph:caret-down w-4 h-4 text-bolt-elements-textSecondary opacity-75 transition-transform duration-300',
        ...
        {isProviderDropdownOpen && (
          <div
            className="absolute z-20 w-full mt-1 py-1 rounded-xl border border-cyan-500/20 bg-black/90 backdrop-blur-xl shadow-[0_8px_32px_rgba(0,229,255,0.12)] animate-in fade-in-0 zoom-in-95 slide-in-from-top-2 duration-200"
            role="listbox"
            id="provider-listbox"
          >
              ...
              {filteredProviders.length === 0 ? (
                ...
                filteredProviders.map((providerOption, index) => (
                  <div
                    ...
                    className={classNames(
                      'px-3 py-2.5 text-sm cursor-pointer rounded-lg mx-1',
                      ...
                      provider?.name === providerOption.name
                        ...
                        : undefined,
                      focusedProviderIndex === index ? 'ring-1 ring-inset ring-cyan-500/40 bg-cyan-500/5' : undefined,
                    )}
                    onClick={(e) => {
                      e.stopPropagation();
      ...
      <div className="relative flex w-full min-w-[70%]" onKeyDown={handleModelKeyDown} ref={modelDropdownRef}>
        ...
        {isModelDropdownOpen && (
          <div
            className="absolute z-10 w-full mt-1 py-1 rounded-xl border border-cyan-500/20 bg-black/90 backdrop-blur-xl shadow-[0_8px_32px_rgba(0,229,255,0.12)] animate-in fade-in-0 zoom-in-95 slide-in-from-top-2 duration-200"
            role="listbox"
            id="model-listbox"
          >
                  ...
                  <div
                    ...
                    className={classNames(
                      ...
                      model === modelOption.name
                        ? 'bg-cyan-500/10 text-cyan-300 border-l-2 border-cyan-400'
                        : undefined,
                      focusedModelIndex === index ? 'ring-1 ring-inset ring-cyan-500/40 bg-cyan-500/5' : undefined,
                    )}
                    onClick={(e) => {
                      e.stopPropagation();
