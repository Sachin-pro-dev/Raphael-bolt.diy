...
export const Artifact = memo(({ artifactId }: ArtifactProps) => {
  ...
  return (
    <>
      <div className="artifact p-2 border border-bolt-elements-borderColor flex flex-col overflow-hidden rounded-lg w-full transition-border duration-150">
        <div className="flex">
          <button
            className="flex items-stretch bg-bolt-elements-artifacts-background hover:bg-bolt-elements-artifacts-backgroundHover w-full overflow-hidden bg-black"
            onClick={() => {
