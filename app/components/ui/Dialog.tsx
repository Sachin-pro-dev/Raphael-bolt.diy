  ...
  return (
    <button
      className={classNames(
        ...
        type === 'primary'
          ? 'bg-cyan-500 text-white hover:bg-cyan-600 dark:bg-cyan-500 dark:hover:bg-cyan-600'
          : type === 'secondary'
  ...
  return (
    <RadixDialog.Portal>
      ...
      <RadixDialog.Content asChild>
        <motion.div
          className={classNames(
            'fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-white dark:bg-black/90 dark:backdrop-blur-xl rounded-2xl shadow-xl border border-bolt-elements-borderColor z-[9999] w-[520px] focus:outline-none',
            className,
          )}
          initial="closed"
          animate="open"
  ...
  return (
    <RadixDialog.Root open={isOpen} onOpenChange={onClose}>
      <Dialog showCloseButton={false}>
        <div className="p-6 bg-white dark:bg-black relative z-10">
